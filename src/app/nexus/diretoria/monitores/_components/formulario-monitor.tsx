...
export function FormularioMonitor({
	cancelar,
	editandoId,
	rascunho,
	setRascunho,
	salvar,
	formValido,
}: FormularioMonitorProps) {
	return (
		<div className="view-diretoria-monitores-formulario-monitor bg-white rounded-2xl border border-gray-200 overflow-hidden">
